...
def geo_integ(p, in_edge, out_edge):
    '''
...
class Image:
    ...
    def create_photons(self, detector):
        '''
    ...
    def create_image(self, acc_structure):
        '''
        ...
        for p in self.photon_list:
            geo_integ(p, acc_structure.in_edge, acc_structure.out_edge)
